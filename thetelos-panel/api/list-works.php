...
/* ════════════════ MODE: list ════════════════ */
// Maliyet nedeniyle liste üretimi DeepSeek ile yapılır (Claude kredisi yok).
// DeepSeek kanonu zayıf hatırlayabilir; prompt'taki AUTHENTICITY/NO DUPLICATES
// kuralları + aşağıdaki normalize-dedup bunu telafi etmeye çalışır.
$provider = 'deepseek';
