...
$mp = "Generate SEO metadata for \"{$book}\" by {$author}.\n\n"
    ...
    . "- categories: REQUIRED. Pick 2-5 slugs that best match this specific work, ONLY from this list: {$cats}\n"
    . "- Never leave categories empty. Choose the most relevant subject slugs for THIS book.\n"
