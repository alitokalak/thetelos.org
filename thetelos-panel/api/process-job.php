...
curl_setopt_array($ch2,[
    ...
    CURLOPT_POSTFIELDS=>json_encode(['model'=>(in_array(DEEPSEEK_MODEL,['deepseek-chat','deepseek-reasoner'],true)?'deepseek-v4-flash':DEEPSEEK_MODEL),'max_tokens'=>400,'messages'=>[['role'=>'user','content'=>$mp]]]),
]);
