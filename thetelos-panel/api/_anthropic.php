...
function tls_claude_overview($book, $author, $opts = []) {
    ...
    $system =
      ...
      . "4. LENGTH — use the FULL extent of your genuine knowledge. Aim for roughly "
      . "$cap_lo–$cap words, treating $cap as a HARD CEILING. Knowing a work only 'in "
      . "outline' is NOT a reason to be terse: if you can reliably place it (its "
      . "author, the KIND of work, its subject or argument, the intellectual/historical "
      . "context, the author's characteristic concerns, its purpose, reception, and "
      . "significance), then DEVELOP each of those thoughtfully and in depth — real "
      . "analysis and context, written in full paragraphs. That is genuine knowledge "
      . "made useful, NOT padding. What is forbidden is inventing SPECIFICS you are not "
      . "sure of (plot points, quotes, dates, chapter lists, names) — never do that to "
      . "reach a length. But do not stop at a bare two-sentence note when you genuinely "
      . "have more to say that is true: write the fullest honest treatment you can. Only "
      . "when you truly know very little for certain should the text be short.\n"
    ...
    $user =
      ...
      . "Target length: aim for a full overview of about $cap_lo–$cap words, and do "
      . "NOT exceed $cap words under any circumstances. Do not be needlessly brief: if "
      . "you can reliably place the work and its author, DEVELOP what you genuinely know "
      . "— its subject, argument, themes, context, purpose, reception and significance — "
      . "in real depth and full paragraphs, reaching for the $cap_lo–$cap range. Only if "
      . "you truly know very little for certain should it fall well short. Never invent "
      . "specifics to fill space. Do NOT add any note about your own knowledge or its limits, "
      ...
      . "(##). Write ENTIRELY IN ENGLISH — even if the work is in another language, "
      . "write the overview in English; never output in the book's original language.\n\n"
