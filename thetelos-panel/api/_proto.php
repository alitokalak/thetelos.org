...
function proto_sbs_prompt($book, $author, $notes, $g, $G, $seg_words = 0) {
    ...
    return "OUTPUT LANGUAGE — WRITE ENTIRELY IN ENGLISH, even if the notes are in another language; translate their content. Never write headings or prose in the book's original language.\n\n"
        ...
        . "VOICE — write like a human essayist telling a reader how the book unfolds: natural, flowing English. NEVER announce the format or narrate what you are doing (no 'Here is…', 'In this part…', 'This section covers…'); just tell what happens. Under each ### write real connected paragraphs, not clinical bullet-like lines.\n"
