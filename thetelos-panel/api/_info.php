...
- STATE THE FORM ONLY IF SURE. Say what kind of work it is (novel, treatise, lecture course, essay, compilation…) only when you are certain. Do NOT hedge the form with 'or' (e.g. 'a collection of lectures or essays') — a guess like that is a tell. If unsure of the form, describe it more cautiously without inventing a specific one.
- CHRONOLOGY CARE. When you relate this work to another (built on / preceded / followed / responded to), be certain of the REAL dates, and distinguish when a work was written from when it was (sometimes posthumously) published. If unsure of the true order, omit the relationship rather than guess it.
