...
3. Click on the 'Activate' button to use your new theme right away. Enter license key.
4. Navigate to Theme Setup, install required plugins, (optional) import starter sites, then go to Appearance > Customize > Mediumish Theme in your admin panel.

== Copyright ==
Mediumish WordPress Theme, Copyright 2018-2025 WowThemes.net.
