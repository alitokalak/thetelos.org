...
function tls_cat_guess_main($name, $slug) {
    ...
    $fam = [
        ...
        'philosophy'=>['philosophy','philosophical','philosopher','ethics','ethical','metaphysics','epistemology','logic','aesthetics','existential','existentialism','phenomenology','idealism','materialism','rationalism','empiricism','pragmatism','stoicism','stoic','nihilism','nihilist','hermeneutics','dialectic','dialectics','ontology','determinism','utilitarianism','positivism'],
        'religion-spirituality'=>['religion','religious','theology','theological','church','bible','biblical','quran','koran','islam','islamic','christian','christianity','catholic','protestant','judaism','jewish','buddhism','buddhist','hindu','hinduism','spiritual','spirituality','mysticism','mystical','saint','saints','prayer','scripture','gnostic','sufi','sufism','taoism','taoist','confucian','confucianism','zen','kabbalah','vedanta','yoga'],
        ...
        'social-sciences'=>['sociology','sociological','social','society','anthropology','anthropological','politics','political','government','governance','democracy','anarchism','socialism','communism','marxism','marxist','liberalism','conservatism','capitalism','fascism','nationalism','colonialism','postcolonial','law','legal','jurisprudence','education','pedagogy','teaching','geography','gender','feminism','feminist','race','ethnic','african','asian','migration','media','communication','journalism','criminology','linguistics','language','semiotics','semiotic','structuralism'],
