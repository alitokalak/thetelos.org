    ...
    <div class="container">
        ...
        <div class="tls-single-grid">
            ...
            <div class="tls-single-content">
                ...
                <!-- Bu post hangi listelerde -->
                <?php
                $post_lists = function_exists('tls_get_lists_for_post') ? tls_get_lists_for_post($post_id) : [];
                if ( ! empty($post_lists) ) :
                ?>
                <div class="tls-in-lists">
                    <p class="tls-in-lists-label">Part of reading path</p>
                    <?php foreach ($post_lists as $pl) : ?>
                    <span class="tls-in-list-item">
                        <?php echo esc_html($pl['emoji']); ?>
                        <?php echo esc_html($pl['title']); ?>
                        <span style="color:var(--tls-muted);">(<?php echo (int)$pl['count']; ?> books)</span>
                    </span>
                    <?php endforeach; ?>
                </div>
                <?php endif; ?>
