...
/* ── Ana sorguyu kullan (pre_get_posts ile zaten filtrelenmiş) ── */
$search_q = $wp_query;
...
<div class="container tls-search-layout">
    ...
    <div class="tls-search-results">
        ...
        <div class="bottompagination" style="margin-top:40px;">
            <?php
            /* Tüm aktif filtreleri taşıyan base URL */
            $pagination_base = add_query_arg( array_filter( [
                's'          => $search_query,
                'tls_sort'   => $filter_sort   ?: null,
                'tls_cat'    => $filter_cat    ?: null,
                'tls_author' => $filter_author ?: null,
            ] ), home_url( '/' ) );
